...
import com.csmake.GuidObject;
import com.csmake.JSONReturn;
...
public class StatementServlet extends HttpServlet{
    ...
    */
    ...
    throws ServletException, IOException
    {
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>post method for the <span style='color:blue'> org.dbcloud.mysql.Statement</span> servlet call</h1>");
    ...
    */
    ...
    private JSONReturn Recive(com.csmake.ClassLoader loader, com.csmake.JSONInvoke context, java.util.HashMap<String, Object> ctx)
    {
        int errorCode = 0;
        Object retValue = null;
        String exception = "";
        com.csmake.GuidObject<mysql.Statement> guidObject = _maps.get(context.guid);
        try
        {
            switch (context.symbol){
                case "constructor" :{ 
                    ...
                    if ("class".equals(guid)) {
                        guidObject = _maps.get("org.dbcloud.mysql.Statement");
                        guid = "org.dbcloud.mysql.Statement";
                    ...
                    if ("class".equals(guid)) {
                     ...
                     if (guidObject == null) {
                        ...
                        if(clazz!=null){
                            ...
                            Object obj = con.newInstance((String)(context.args.get("0")));
                            guidObject = new com.csmake.GuidObject((mysql.Statement)obj);
                            guid=this.getInitParameter("guid");
                            if (guid == null) {
                                context.guid = java.util.UUID.randomUUID().toString();
                            } else if ("class".equals(guid)) {
                ...
                /** public field */
                case "get_configs" :{ 
                    retValue = guidObject.getObject().configs;
                    break;
                }
                case "set_configs" :{ 
                    guidObject.getObject().configs = JSONObject.parseArray(((JSONArray)context.args.get("0")).toJSONString(), java.lang.String.class).toArray(new java.lang.String[0]);
                    break;
                }
                case "get_id" :{ 
                    retValue = guidObject.getObject().id;
                    break;
                }
                case "set_id" :{ 
                    guidObject.getObject().id = Long.valueOf(context.args.get("0").toString());
                    break;
                }
            ...
            if(guidObject == null || guidObject.getObject()== null){
                exception="org.dbcloud.mysql.Statement is null pointer.";
            }else{
    ...
    private java.util.HashMap<String, com.csmake.GuidObject<mysql.Statement> > _maps = null;
