...
public class Statement {
    ...
    private  jdbc.ResultSet convResultSet(ResultSet rs,  jdbc.ResultSet result, Document options) throws SQLException {
        if (rs != null) {
     ...
     */
    public  jdbc.ResultSet executeQuery(String sql) {
         jdbc.ResultSet result = new  jdbc.ResultSet();
        ResultSet rs = null;
        try {
    ...
    public  jdbc.ResultSet executeQuery(String sql, Document options) {
        if (options.getBoolean("document", false)) {
            ResultSet rs = null;
             jdbc.ResultSet result = new  jdbc.ResultSet();
            try {
     ...
     * @param parameters 瀛樺偍杩囩▼鍙傛暟 Document{ParameterName: ,Document{Direction:
     * ,SqlType: ,Value: ,OutValue: }}
     * ParameterName:鍙傛暟鍚嶇О锛孌irection锛氭爣璇嗚緭鍏ヨ緭鍑哄弬鏁�(in,out),SqlType:鍙傛暟绫诲瀷(java.sql.Types)
     * Value:鍙傛暟鍊硷紝OutValue:杈撳嚭鍙傛暟鍊�
     * @param options {"document": (true or false)}"document:true"杩斿洖缁撴灉涓�"rows":[{
     * ... },{...}],"document:false"杩斿洖缁撴灉涓�"rows":[[...],[...]]
     * @return 杩斿洖Document鍐呭锛氬瓨鍌ㄨ繃绋嬭繑鍥炵殑缁撴灉
     */
    public  jdbc.ResultSet executeProcedure(String procedureName, Document parameters, Document options) {

        ResultSet rs = null;
         jdbc.ResultSet resultDocument = new  jdbc.ResultSet();
        ...
        try {
            ...
            // <editor-fold desc="鏋勯�燾allString">
            ...
            // <editor-fold desc="鍚慶allableStatement璁剧疆鍙傛暟鍊�">
            int i = 0;
            for (String parameterName : parameters.keySet()) {
                ...
                if (parameterDirection == "out") {
                    ...
                    if (sqlType == java.sql.Types.INTEGER) {
                        ...
                        try {
                            callableStatement.setTimestamp(i + 1, parameter.get("Value", java.sql.Timestamp.class)); //闇�瑕佹祴璇� 
     ...
     * @see #execute
     */
    public  jdbc.ResultSet getResultSet() throws SQLException {
         jdbc.ResultSet result = new  jdbc.ResultSet();
        convResultSet(stmt.getResultSet(), result, new Document());
        return result;
    }

    public  jdbc.ResultSet getResultSet(Document options) throws SQLException {
         jdbc.ResultSet result = new  jdbc.ResultSet();
     ...
     * @since 1.4
     */
    public  jdbc.ResultSet getGeneratedKeys() throws SQLException {
         jdbc.ResultSet result = new  jdbc.ResultSet();
        convResultSet(stmt.getGeneratedKeys(), result, new Document());
        return result;
    }

    public  jdbc.ResultSet getGeneratedKeys(Document options) throws SQLException {
         jdbc.ResultSet result = new  jdbc.ResultSet();
