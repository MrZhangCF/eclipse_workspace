...
public class StatementServlet extends HttpServlet{
    ...
    */
    ...
    throws ServletException, IOException
    {
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>post method for the <span style='color:blue'>  jdbc.Statement</span> servlet call</h1>");
    ...
    */
    ...
    private com.csmake.JSONReturn Recive(com.csmake.ClassLoader loader, com.csmake.JSONInvoke context, java.util.HashMap<String, Object> ctx)
    {
        ...
        String exception = "";
        com.csmake.GuidObject< jdbc.Statement> guidObject = _maps.get(context.guid);
        try
        {
            switch (context.symbol){
                case "constructor" :{ 
                    ...
                    if ("class".equals(guid)) {
                        guidObject = _maps.get(" jdbc.Statement");
                        guid = " jdbc.Statement";
            ...
            if(guidObject == null || guidObject.getObject()== null){
                exception=" jdbc.Statement is null pointer.";
            }else{
    ...
    private java.util.HashMap<String, com.csmake.GuidObject<jdbc.Statement> > _maps = null;
